...
\subtitle{Master's thesis project - meeting 13}
\author[C Nielsen]{Cole Nielsen}
\institute[NTNU]{Department of Electronic Systems, NTNU}
\date{24 Apr 2020  (calendar week 17)}
...
\begin{frame}
	...
	\begin{block}{For this week...}
		\begin{enumerate}[itemsep=4pt,label=\protect\mycirc{\arabic*}]
			\scriptsize
			\item Calibration, control logic.
			\item Phase detectors (BBPD, sync. counter).
			% \item Oscillator buffer, level shifters.
		\end{enumerate} 
	\end{block}	
\end{frame}
...
% 			\tiny
% 			\begin{itemize}[itemsep=4pt,label=\protect---]
% 			        \item  Manual layout, due to usage of custom diff-single ended TSPC DFF.
% 			\end{itemize}
% 			% \vspace{-3em}
% 		\end{minipage}%
% 		% \hspace{-0.5cm}
...
% \begin{frame}
% 	\frametitle{Level shifter.}
% 	\begin{block}{Architecture.}
% 		\begin{minipage}{4cm}
% 			\vspace{1em}
% 			\tiny
% 			\begin{itemize}[itemsep=4pt,label=\protect---]
% 			        \item  Digital parts at 0.5V for power reasons, ring oscillator at 0.8V.
% 			\end{itemize}
% 			% \vspace{-3em}
% 		\end{minipage}%
% 		% \hspace{-0.5cm}
