...
\subtitle{Master's thesis project - meeting 9}
\author[C Nielsen]{Cole Nielsen}
\institute[NTNU]{Department of Electronic Systems, NTNU}
\date{13 March 2020  (calendar week 11)}
...
\begin{frame}
	...
	\begin{table}[htb!]
		...
		\begin{tabular}{|c|l|l|l|}
			...
			\hline 
			\rule[-1ex]{0pt}{2.5ex}\cellcolor{green!40}\textbf{11}&\cellcolor{green!40}9.3 - 15.3&\cellcolor{green!40}Layout: oscillator &\cellcolor{green!40} \\ 
			\hline 
